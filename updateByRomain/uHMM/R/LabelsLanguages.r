...
.languageManagement<-function(language){
  ...
  if(language=="fr"){
    textToDisplay<-c(
      ...
      "Importer le jeu de donn\UE9\U65s d'exemple (Gamme Capteur)",
